...
"background-color: rgb(0, 255, 255);")
        ...
        self.vest.setStyleSheet("image: url(:/vest/vest.png);\n""background: none;")
        self.vest.setPixmap(QPixmap("vest.png"))
        self.vest.setObjectName("vest")
        self.glove = QtWidgets.QLabel(Form)
        self.glove.setGeometry(QtCore.QRect(800, 300, 91, 61))
        self.glove.setStyleSheet("image: url(:/gloves/gloves.png);")
        self.glove.setObjectName("glove")
        
        self.label_15 = QtWidgets.QLabel(Form)
        self.label_15.setGeometry(QtCore.QRect(360, 0, 51, 61))
        self.label_15.setStyleSheet("image: url(:/worker/construction-worker.png);")
        self.label_15.setPixmap(QPixmap("construction-worker.png"))
...
"font-weight: 600")
    ...
    def retranslateUi(self, Form):
        ...
        self.name.setText(_translate("Form", "<html><head/><body><p><br/></p></body></html>"))
        self.label_6.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">DAY IN:</span></p></body></html>"))
        self.day.setText(_translate("Form", "<html><head/><body><p><br/></p></body></html>"))
        self.label_8.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">TIME IN:</span></p></body></html>"))
        self.time.setText(_translate("Form", "<html><head/><body><p><br/></p></body></html>"))
        self.helmet.setText(_translate("Form", "<html><head/><body><p><br/></p></body></html>"))
        ...
        self.vest.setText(_translate("Form", "<html><head/><body><p><br/></p></body></html>"))
        self.glove.setText(_translate("Form", "<html><head/><body><p><br/></p></body></html>"))
        self.label_16.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">RESULT:</span></p></body></html>"))
        self.label_17.setText(_translate("Form", "<html><head/><body><p><br/></p></body></html>"))
